...
function loginRoutes($stateProvider, USER_ROLES) {
    ...
    var login = {
        ...
        data: {
            ...
            pageTitle: 'Login to Wigwam Design Studio', // set the title in the <head> section of the index.html file
            pageDescription: 'Wigwam Design Login', // meta description in <head>
